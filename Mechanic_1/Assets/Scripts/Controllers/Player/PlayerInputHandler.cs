...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    {
        RectTransform tmpDirectory = _directory.GetComponent<RectTransform>();
        RectTransform tmpInput = _inputText.GetComponent<RectTransform>();

        tmpInput.sizeDelta = new Vector2((1880 - (_directory.text.Length * 10)) - (_directory.text.Length * _directory.text.Length), 62);

        _playerInput.ForceLabelUpdate();
    }
